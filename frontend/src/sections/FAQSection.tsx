...
const faqs = [
  {
    ...
    answer:
      "NexusAI learns from your catalog import — descriptions, prices, categories, and images. It uses this knowledge to recommend the right products and answer detailed questions about availability, sizing, specifications, and more.",
  },
  {
  ...
  return (
    <section id="faq" className="bg-[#f5f3ef] py-[120px]">
      <div className="content-container-narrow">
        <SectionHeader label="FAQ" heading="Questions? Answered." />
