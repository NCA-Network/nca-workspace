    ...
    <div className="p-8 max-w-[1200px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {statCards.map((stat) => (
          <div
            key={stat.label}
            className="bg-white rounded-xl border border-[#e0dcd6] p-6"
          >
            <p className="font-body text-sm text-[#8a8580] mb-2">{stat.label}</p>
            <p
              className="font-display text-3xl"
              style={{ color: stat.color, fontWeight: 400 }}
            >
              {stat.value}
            </p>
          </div>
      ...
      <div className="bg-white rounded-xl border border-[#e0dcd6] p-6 mb-8">
        <h2 className="font-body text-lg font-semibold text-[#1a1814] mb-4">
          Quick Actions
        </h2>
